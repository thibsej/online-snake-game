...
public class Snake {
	...
	synchronized public Snake isInCollision(HashSet<Snake> a) {
		for (Snake b : a)
			if (isInCollision(b))
				return b;
		return null;
	...
	public static void main(String[] args) {
		...
		s2.move();
		HashSet<Snake> h = new HashSet<Snake>();
		h.add(s);
		h.add(s2);
		System.out.println("Snake 2 had collision with " + s2.isInCollision(h));
